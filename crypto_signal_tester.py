...
def main():
    ...
    with col1:
        ...
        signal_text = st.text_area(
            ...
            help="Example formats:\n"
                 ...
                 "SOL/USDT buy at 120, SL 115, TP1 125, TP2 130, TP3 135, Time: 2024-10-20 16:30:00"
        )
    ...
    with col2:
        ...
        st.code("""SOL/USDT buy at 120, SL 115, TP1 125, TP2 130, TP3 135, Time: 2024-10-20 16:30:00""")
